...
class AdminRightTop extends React.Component {
  ...
  var checkTd = function(defaultTd) {
        ...
        if(this.props.thitem.type=="operation"){
          return (
              <td>
              <p className="display_inline_block button_margin"><a href={"exam_record_view?id="+id}  className="btn btn-info btn-xs operate_announce">查 看</a></p>
